...
TEST(laplace_tests,fast_laplace_convergence_1){
  ...
  set_mesh_value(1000.0,20,20,20,potentials,mesh_geometry);
  set_mesh_value(1,20,20,20,boundaries,mesh_geometry);
//


  fast_relax_laplace_potentials(potentials, boundaries, 1);
  printf("%f\n", get_mesh_value_world_point(0.007,0.007,0.007,potentials,mesh_geometry));
