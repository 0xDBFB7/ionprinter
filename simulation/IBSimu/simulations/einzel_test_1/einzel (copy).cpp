...
void simu( void )
{
    ...
    geom.set_boundary( 8, Bound(BOUND_DIRICHLET, -50.0) );
    ...
    for( size_t i = 0; i < 5; i++ ) {
		...
		pdb.add_2d_beam_with_energy( 1000, //beam traces 
									 6.5e6, //beam current, A/m^2
									 1.0, //particle charge, q
									 27.0, //mass in AMU of the particles 
									 48, //Energy of the particles, EV 
									 0.0,
									 0.0, 
									 0.0,
									 0.0, 
